<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nonStatistiche.aspx.cs" Inherits="NomeProgetto.nonStatistiche" ContentType="text/html;charset=utf-8" %>
            ...
            <div class="row mb-4">
                <div class="col-12 mb-3">
                    <h2 class="text-primary mb-2">
                        ...
                        <asp:Label ID="lblEmail" runat="server" Text="" /> - "Ho Fumato"
                    </h2>
                </div>
                ...
                <div class="col-12">
                    <div class="alert alert-info">
                        ...
                        <strong>Come funziona:</strong> Ogni volta che fumi una sigaretta, registri l'evento. 
                        Queste statistiche ti mostrano le tue abitudini e ti aiutano a identificare i momenti più critici della giornata.
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                        ...
                        <div class="content">
                            <h6 class="text-muted mb-1">
                                ...
                                <i class="bi bi-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" 
                                   title="Il numero totale di sigarette che hai fumato"></i>
                            </h6>
                ...
                <div class="col-12 col-sm-6">
                    <div class="stat-summary-card">
                        ...
                        <div class="content">
                            <h6 class="text-muted mb-1">
                                Tempo Totale tra le Sigarette
                                <i class="bi bi-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" 
                                   title="Il tempo totale accumulato tra una sigaretta e l'altra"></i>
                            </h6>
                ...
                <div class="col-12 col-sm-6">
                    <div class="stat-summary-card">
                        ...
                        <div class="content">
                            <h6 class="text-muted mb-1">
                                Tempo Medio tra Sigarette
                                <i class="bi bi-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" 
                                   title="In media, quanto tempo passa tra una sigaretta e l'altra"></i>
                            </h6>
                    ...
                    <div class="stat-summary-card">
                        ...
                        <div class="content">
                            <h6 class="text-muted mb-1">
                                ...
                                <i class="bi bi-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" 
                                   title="Come sta andando questa settimana rispetto alla scorsa: un valore negativo indica che stai fumando meno"></i>
                            </h6>
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <h5 class="card-title mb-0">
                                ...
                                Tempi tra le Sigarette
                                <i class="bi bi-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" 
                                   title="Il tempo più breve e più lungo registrato tra una sigaretta e l'altra"></i>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <h5 class="card-title mb-0">
                                ...
                                Quando Fumi di Più
                                <i class="bi bi-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" 
                                   title="Ti mostra in quale ora del giorno e in quale giorno della settimana fumi più spesso"></i>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <h5 class="card-title mb-0">
                                ...
                                Il Tuo Progresso
                                <i class="bi bi-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" 
                                   title="Confronta quante sigarette hai fumato questa settimana rispetto alla scorsa"></i>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
